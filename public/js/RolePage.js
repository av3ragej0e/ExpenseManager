"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["RolePage"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    deleteItemConfirm: function deleteItemConfirm() {
      ...
      axios.post('/delete_role', this.editedItem).then(function (response) {
        _this.getRole();
      });
      this.closeDelete();
    },
    ...
    save: function save() {
      ...
      if ("id" in this.editedItem) {
        axios.put('/update_role', this.editedItem).then(function (response) {
          _this4.getRole();

          _this4.close();
        });
      } else {
        axios.post('/add_role', this.editedItem).then(function (response) {
          _this4.getRole();
                  ...
                  fn: function (ref) {
                    ...
                    return [
                      ...
                      _c(
                        "v-icon",
                        {
                          attrs: { small: "", disabled: !!item.user.length },
                          on: {
                            click: function ($event) {
